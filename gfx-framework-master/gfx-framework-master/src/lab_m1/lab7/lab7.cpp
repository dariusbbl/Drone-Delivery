...
void Lab7::RenderSimpleMesh(Mesh* mesh, Shader* shader, const glm::mat4& modelMatrix, const glm::vec3& color)
{
    ...
    glUniform1f(glGetUniformLocation(shader->program, "material_kd"), materialKd); // diffuse

    glUniform1f(glGetUniformLocation(shader->program, "material_ks"), materialKs); // specular
